...
local sets = {
    ...
    Tp_Default = {
		...
		Ring1="Ayanmo Ring",
		Ring2="Chirich Ring +1"	,
		Back={ Name="Ogma\'s cape", Augment={'DEX+20','Accuracy+20 Attack+20','Weapon skill damage +10%','Phys. dmg. taken-10%','DEX+10',}}
    },
    Tp_Hybrid = {
        Main = 'Epeolatry',
        Sub = 'Utu Grip',
    ...
    Tank_Main = {--Default Tanking,  dt 
		...
		Ring1="Moonbeam Ring",
		Ring2="Murky Ring",
	    Back={ Name="Ogma\'s Cape", Augment={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Enmity+10','Phys. dmg. taken-10%',}}
        },
    Tank_MEVA = {
    ...
    SIR = {--10 merits + 90
		...
		Legs={ Name="Carmine Cuisses +1", Augment={'Accuracy+12','DEX+12','MND+20',}},
		Feet="Agwu's Pigaches",
    ...
    SIRenmity = { -- Foil and blue spells mostly
		...
		Ring1="Murky Ring",
		Ring2="Moonlight Ring", 
		Back={ Name="Ogma\'s cape", Augment={'HP+60','Eva.+20 /Mag. Eva.+20','Enmity+10','Parrying rate+5%',}}
    },
    ...
    Ws_Default = {
		...
		Ring1="Regal Ring",
		Ring2="Ilabrat Ring",
		Back={ Name="Ogma\'s cape", Augment={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
    },
    Ws_Hybrid = {
    },
    Ws_Acc = {
